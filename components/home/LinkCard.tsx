...
const LinkCard: React.FC<LinkCardProps> = ({
  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, transition: { delay: 0.3 } }} viewport={{ once: true }}>
      <Link
        href={href}
        className="group grid grid-cols-2 place-items-center gap-4 overflow-hidden rounded-2xl border border-gray-300 bg-sky-100/80 py-5 px-8 dark:border-gray-500 dark:bg-gray-600"
      >
